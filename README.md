...
<div align = "left" style ="margin: 20px; font-size: 16px;">
    <p><strong>Name:</strong> TanviG35-Python </p>
    <p><strong>Email ID:</strong> tanvichoure07@gmail.com </p>
    <p><strong>College Name:</strong> Jaihind College of Engineering </p>
    <p><strong>Branch/Specialization :</strong> Computer Engineering </p>
    <p><strong>College ID:</strong> 2220187 </p>
</div>
...
<div align="left" style="margin: 20px; font-size: 16px;">
    <p><strong>Course Opted:</strong> Python </p>
...
<p><strong>Trainer Designation:</strong> Python </p>
...
During this project, I gained practical experience in building an AI-powered application using modern technologies.

I developed a strong understanding of Python-based development, LLM integration, and web app deployment.
I learned how to process real-world data from news articles, implement semantic search, and generate meaningful insights using AI.

Through this project, I strengthened my skills in:

Problem-solving and analytical thinking
Working with APIs and handling unstructured data
Implementing Retrieval-Augmented Generation (RAG)
Designing interactive applications using Streamlit
Writing clean, structured, and maintainable code

Overall, this project enhanced both my technical skills and practical approach to building real-world AI solutions.


<h2 style="color:#333;"> Projects Completed </h2>
<div align="left" style="margin: 20px; font-size: 16px;">

<p><strong><a href="#project1">Project 1:</a></strong> News Research Tool Using LLM </p>
...
<!-- Project 1 -->
<h3 id="project1">Project 1: News Research Tool Using LLM </h3>
<p>
  An AI-powered news analysis tool that extracts insights from multiple news articles using LLMs. 
  Users can input article URLs and ask questions to receive accurate, source-backed answers through semantic search and Retrieval-Augmented Generation (RAG). 
...
https://www.researchgate.net/publication/382717485_LLM_Based_News_Research_Tool_Using_LangChain_with_Enhancing_Similarity_Search_and_Token_Limit


## **Learnings from LST and SST**

LST (Life Skills Training) and SST (Social Skills Training) sessions helped me develop both technical and interpersonal abilities during my internship.
ces over here .
Through these sessions, I learned:

Effective communication and presentation skills
Problem-solving and analytical thinking
Time management and teamwork
How to apply technical knowledge to real-world projects
